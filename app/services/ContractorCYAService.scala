...
class ContractorCYAService @Inject()(inYearUtil: InYearUtil, cisSessionService: CISSessionService)
                                    (implicit ec: ExecutionContext) {

  //scalastyle:off
  def pageModelFor(taxYear: Int, month: Month, refNumber: String, user: User)(implicit hc: HeaderCarrier): Future[Either[ServiceError, ContractorCYAPage]] = {
