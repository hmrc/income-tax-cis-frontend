...
class TailoringDataConnector @Inject()(val http: HttpClient,
  ...
  def clearExcludedJourney(taxYear: Int, nino: String)
    ...
    http.POST[JsObject, ClearExcludedJourneysResponse](clearExcludedJourneysUrl, Json.obj("journeys" -> Seq("cis")))(
  ...
  def postExcludedJourney(taxYear: Int, nino: String)
    ...
    http.POST[JsObject, PostExcludedJourneyResponse](postExcludedJourneyUrl, Json.obj("journey" -> "cis"))(
