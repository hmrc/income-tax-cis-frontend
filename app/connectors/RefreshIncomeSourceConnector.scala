...
class RefreshIncomeSourceConnector @Inject()(val http: HttpClient,
  ...
  def put(taxYear: Int, nino: String)(implicit hc: HeaderCarrier): Future[RefreshIncomeSourceResponse] = {
    ...
    val cis = "cis"
    http.PUT[RefreshIncomeSourceRequest, RefreshIncomeSourceResponse](targetUrl, RefreshIncomeSourceRequest(cis))
  }
}
