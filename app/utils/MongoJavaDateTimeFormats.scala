...
trait MongoJavaDateTimeFormats {
  outer =>
  ...
  final val localDateTimeWrites: Writes[LocalDateTime] =
    Writes.at[String](__ \ "$date" \ "$numberLong")
      .contramap(_.atZone(ZoneOffset.UTC).toInstant.toEpochMilli.toString)
...
object MongoJavaDateTimeFormats extends MongoJavaDateTimeFormats