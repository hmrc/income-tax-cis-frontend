...
import models.{GetIncomeTaxUserDataError, User}
...
trait MockDeductionsSummaryService extends MockFactory {
  ...
  def mockPageModelFor(taxYear: Int,
                       user: User,
                       result: Either[GetIncomeTaxUserDataError, DeductionsSummaryPage]
                      ): CallHandler3[Int, User, HeaderCarrier, Future[Either[GetIncomeTaxUserDataError, DeductionsSummaryPage]]] = {
