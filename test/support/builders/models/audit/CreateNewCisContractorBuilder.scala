...
import audit.CreateNewCisContractor
import support.builders.models.audit.DeductionPeriodDataBuilder.aDeductionPeriodData

object CreateNewCisContractorBuilder {
  val aCreateNewCisContractor: CreateNewCisContractor =
    CreateNewCisContractor(
      contractorName = Some("ABC Steelworks"),
      ern = "123/AB123456",
      customerDeductionPeriod = aDeductionPeriodData
    )
}
