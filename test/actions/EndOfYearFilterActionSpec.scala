...
class EndOfYearFilterActionSpec extends UnitTest
  ...
  ".executionContext" should {
    "return the given execution context" in {
      val underTest = EndOfYearFilterAction(taxYear = taxYear, inYearUtil = inYearUtil, appConfig = appConfig)(executionContext)
  ...
  ".filter" should {
    ...
    "return None when taxYear is end of year" in {
      val underTest = EndOfYearFilterAction(taxYear = taxYearEOY, inYearUtil = inYearUtil, appConfig = appConfig)(executionContext)
